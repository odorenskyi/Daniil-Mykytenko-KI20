...
{
    wlocale();
    wcout << L"Якщо ви запускаєте застосунок вперше - створіть у теці с проєктом текстовий файл \"input.txt\", запишіть туди інформацію й після цього запустіть застосунок." << endl << endl;
